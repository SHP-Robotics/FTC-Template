...
public class RRMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 30/24;
    ...
    public RRMecanumDrive(HardwareMap hardwareMap) {
        ...
        //TODO: figure out IMU/control hub stuff. Messing with teleop
        // BNO055IMUUtil.remapZAxis(imu, AxisDirection.NEG_Y); //POS_Y best so far
    ...
    public void setMotorPowers(double v, double v1, double v2, double v3) {
        ...
        leftRear.setPower(-v1); //config for the stupid strafing
