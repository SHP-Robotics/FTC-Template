...
public final class Constants {
    ...
    public static final class Arm {
        ...
        public static final double K_SLIDE_P = 12; // 15 best value
        public static final double K_SLIDE_TOLERANCE = 0.05;
        public static final double K_SLIDE_MAX_VELOCITY = 1;
        public static final double K_SLIDE_G = 0.3; //THIS MIGHT BE AN ISSUE
    ...
    public static final class Scoop {
        ...
        public static final double K_OUT = 0.55;
